...
library Safe112 {
    ...
    function sub(uint112 a, uint112 b, string memory errorMessage) internal pure returns (uint112) {
    ...
    function div(uint112 a, uint112 b, string memory errorMessage) internal pure returns (uint112) {
    ...
    function mod(uint112 a, uint112 b, string memory errorMessage) internal pure returns (uint112) {
        require(b != 0, errorMessage);
        return a % b;
    }
}
